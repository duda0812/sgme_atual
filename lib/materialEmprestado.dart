                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: ClipRRect(
                        ...
                        child:
                            Image.asset(widget.imagemMaterial, fit: BoxFit.contain),
                      ),
                    ),
                    ...
                    ElevatedButton(
                      onPressed: () {
                        if (dataEmprestimo.text.isEmpty ||
                            dataDevolucao.text.isEmpty) {
                          ScaffoldMessenger.of(context).showSnackBar(
                            const SnackBar(content: Text("Preencha as datas!")),
                          );
                          return;
                        }
